...
def _resolve_kaggle_source(source: str) -> str | dict:
    ...
    try:
        ...
        return {"error": "kaggle package is not installed in this environment.", "source": source}
...
def _resolve_huggingface_source(source: str) -> str | dict:
    ...
    try:
        ...
        return {"error": "huggingface_hub package is not installed in this environment.", "source": source}
