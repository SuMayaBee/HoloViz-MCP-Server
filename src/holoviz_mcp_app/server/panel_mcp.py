...
async def pn_list(
    ...
    """
    from holoviz_mcp_app.core.pn import list_components
...
async def pn_get(
    ...
    """
    from holoviz_mcp_app.core.pn import get_component
...
async def pn_params(
    ...
    name : str
        Component name.
    """
    from holoviz_mcp_app.core.pn import get_component_params
...
async def pn_search(
    ...
    limit : int
        Maximum results.
    """
    from holoviz_mcp_app.core.pn import search_components
