...
from holoviz_mcp_app.display.endpoints import HealthEndpoint
from holoviz_mcp_app.display.endpoints import SnippetEndpoint
...
def main(address: str = "localhost", port: int = 5077, show: bool = True) -> None:
    ...
    from holoviz_mcp_app.display.pages import add_page
    from holoviz_mcp_app.display.pages import admin_page
    from holoviz_mcp_app.display.pages import feed_page
    from holoviz_mcp_app.display.pages import view_page
